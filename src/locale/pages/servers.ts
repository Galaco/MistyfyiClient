export default {
  ...
  instructions: {
    free:
      "As a free user, you may watch up to 3 servers. By upgrading, you may watch up to 20 servers.",
    paid:
      "As a paid user, you may watch up to 20 servers. Increased limits are available upon request.",
  },
  buttons: {
    add: "Add server",
    history: "History",
  ...
  server: {
    ...
    players: {
      tooltip:
        "Active players when this server changed map (current player count may differ)",
    },
    updated: {
  ...
  noItems: {
    ...
    description:
      "Once you add your favourite servers, you can view what they are playing here.",
  },
  dialogs: {
    add: {
      title: "Add Server",
      form: {
        ...
        portHelper:
          "Specify the port to connect to (some games do not require this)",
