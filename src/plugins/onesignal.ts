...
// OneSignal is global
declare var OneSignal: OneSignalLib;

const APP_URL = process.env.VUE_APP_URL;
const APP_ID = process.env.VUE_APP_ONESIGNAL_APP_ID;
const APP_ENVIRONMENT = process.env.VUE_APP_ENVIRONMENT;
...
class OneSignalPlugin {
    ...
    public requestNotificationsPermission(callback: any) {
        this.lib.push(() => {
            this.lib.on('subscriptionChange', (isSubscribed) => {
